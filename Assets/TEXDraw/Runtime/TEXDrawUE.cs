...
namespace TexDrawLib
{
    public class TEXDrawUE : VisualElement, ITEXDraw
    {
        ...
        private Core.Overflow m_Overflow = Core.Overflow.Hidden;
        ...
        public Core.Overflow overflow { get => m_Overflow; set { if (m_Overflow != value) { m_Overflow = value; MarkDirtyRepaint(); } } }
