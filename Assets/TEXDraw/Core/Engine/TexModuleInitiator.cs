    ...
    public partial class TexModuleParser
    {
        ...
        public void Initialize()
        {
            ...
            generalCommands = new Dictionary<string, Func<Atom>>();
            {
                ...
                foreach (var key in ClapAtom.alignments.Keys)
                    generalCommands[key] = ClapAtom.Get;
                foreach (var key in PhantomAtom.modes)
                    generalCommands[key] = PhantomAtom.Get;
                ...
                generalCommands["smash"] = SmashAtom.Get;
